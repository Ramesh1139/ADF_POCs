...
*/
DROP TABLE SCH_MST.NRD_UPLD_INPUT_STG CASCADE CONSTRAINTS;

CREATE TABLE SCH_MST.NRD_UPLD_INPUT_STG
(
  ...
  PREPAID_IND            VARCHAR2(1 BYTE),   --Renamed From MANUALLY_PAID_IND
...
CREATE OR REPLACE PUBLIC SYNONYM NRD_UPLD_INPUT_STG
FOR SCH_MST.NRD_UPLD_INPUT_STG;
/
