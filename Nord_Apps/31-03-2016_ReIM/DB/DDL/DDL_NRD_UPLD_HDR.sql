...
/*
  THE FOLLOWING SECTION CONTAINS THE SQL REQUIRED TO CREATE TABLE NRD_UPLD_HDR
*/

DROP TABLE SCH_MST.NRD_UPLD_HDR CASCADE CONSTRAINTS;

CREATE TABLE SCH_MST.NRD_UPLD_HDR
(
  ...
  STATUS_CODE                     VARCHAR2(1 BYTE)     DEFAULT 'I',
  STATUS_DESCRIPTION              VARCHAR2(2000 BYTE),
  SYSTEM_FLAG                     VARCHAR2(1 BYTE)
)
TABLESPACE STAGING_DATA;

CREATE OR REPLACE PUBLIC SYNONYM NRD_UPLD_HDR FOR SCH_MST.NRD_UPLD_HDR;
