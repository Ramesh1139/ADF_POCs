...
public class FacesMessageUtils {
	 ...
	 * @param severity
	 */
	public static void addErrorMessageByCode(String errorMessageKey, Severity severity){
	 ...
	 * @param severity
	 */
	public static void addErrorMessageByCode(String errorMessageKey, String[] params,  Severity severity){
		FacesContext facesContext = FacesContext.getCurrentInstance();
		PropertyResourceBundle bundle = (PropertyResourceBundle) ResourceBundle.getBundle(RESOURCE_BUNDLE, facesContext
				.getExternalContext().getRequestLocale(), Thread
				.currentThread().getContextClassLoader());
...
//	}
	 ...
	 * @param severity
	 */
	public static void addMessageByCode(String errorMessageKey, Severity severity){

		FacesContext facesContext = FacesContext.getCurrentInstance();
		PropertyResourceBundle bundle = (PropertyResourceBundle) 
				ResourceBundle.getBundle(PRESENTATION_RESOURCE_BUNDLE,
	...
	public static String getMessageByKeyForLocale(String resourceKey, Locale locale) { 
		FacesContext facesContext = FacesContext.getCurrentInstance();
		PropertyResourceBundle bundle = (PropertyResourceBundle) 
				ResourceBundle.getBundle(PRESENTATION_RESOURCE_BUNDLE,
				locale,
